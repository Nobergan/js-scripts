...
// getUserWithEmail(usersArray, shereeanthony1111@kog.com);

console.log(getUserWithEmail(usersArray, 'shereeanthony@kog.com'));
console.log(getUserWithEmail(usersArray, 'elmahead@omatom.com'));
console.log(getUserWithEmail(usersArray, 'blackburndotson@furnigeer.com'));
console.log(getUserWithEmail(usersArray, 'shereeanthony1111@kog.com'));
